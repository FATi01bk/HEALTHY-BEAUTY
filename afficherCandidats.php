    ...
    <div class="container">
      ...
      <table>
        ...
        <?php foreach ($candidats as $candidat){ ?>
          <tr>
            ...
            <td>  <a href="deleteCandidat.php?cin=<?= $candidat['cin'] ?>" style="background-color: #ff0000;" class="btn btn-primary">
              ...
              <a href="updateCandidat.php?cin=<?= $candidat['cin'] ?>" style="background-color: #fcc903;" class="btn btn-primary">
        ...
        ?>
          ...
          <a href="offredemploi.php" style="background-color: #fcc903;" class="btn btn-primary"> Ajoute Candidat
