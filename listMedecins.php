    ...
    <div class="header">
            <div class="header-left">
                <a href="index-2.html" class="logo">
                    <img src="assets/img/logo.png" width="35" height="35" alt=""> <span>Healthy Beauty</span>
                </a>
            </div>
        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-inner slimscroll">
                ...
                <ul>
                        ...
                        <li class="active">
                            <a href="listPatients.php"><i class="fa fa-wheelchair"></i> 
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <form method="POST" action="updateMedecin.php">
                                                ...
                                                <input type="hidden" value="<?= $medecin['id']; ?>" name="idMedecin">
                                            </form>
                                        </td>
                                        <td>
                                            <a href="deleteMedecin.php?id=<?= $medecin['id']; ?>">Delete</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
