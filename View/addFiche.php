...
if (
    ...
    if (
        ...
        $fiche_PatientC->addFiche($fiche_patient);
      ...
      <div class="container">
        <div class="contact_nav">
          ...
          <a href="">
            ...
            <span>
              Location:09-rue ibn-esprit arian_soghra
            </span>
          </a>
        </div>
      </div>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex mr-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="Fiches.html">  Les fiches</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="treatment.html"> Rendez-vous</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="doctor.html">Espace Patient</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="testimonial.html">Espace medecin</a>
                </li>
                <li class="nav-item active">
                  <a class="nav-link" href="offredemploi.html">Offre d'emploi</a>
                </li>
      ...
      <div class="row">
        <div class="col">
          ...
          <div id="error">
            ...
            <a href="listFiche.php"> Retour à la liste</a>
            <h4>
                Ajouter <span> Fiche_Patient</span>
            </h4>
          <form method="POST" onsubmit="return validateForm()">
            ...
            <div class="form-row ">
                <div class="form-group col-lg-4">
                  <label for="inputFileNumber">N°fiche </label>
                  <input type="number" step="1" min="01" max="100000 required " required >
                </div>
            </div>
            <div class="form-row ">
              <div class="form-group col-lg-4">
            ...
            <div class="form-row ">
                ...
                <div class="form-group col-lg-4">
                    <label for="inputPhone">Numéro de tel°:</label>
                    <input type="text" class="form-control" id="inputId" placeholder="">
            ...
            <div class="form-row ">
                <div class="form-group col-lg-4">
                    ...
                    <div class="form-group col-lg-13">
                        <input class="form-control" id="inputDate" placeholder="" data-date-format="mm-dd-yyyy">
                        
                      </div>
            </div>
            <div class="row ">
                <div class="form-group col-md-12">
                  <label for="inputFirstName">Maladie :</label>
