...
<body class="sub_page">
  ...
  <?php
    ...
    $candidats = $candidatC->listcandidatsByCin($_GET['cin']);
  ?>
      ...
      <table>
        ...
        <?php foreach ($candidats as $candidat){ ?>
          <tr>
            ...
            <td>  <a href="deleteCandidat.php?cin=<?= $candidat['cin'] ?>" style="background-color: #ff0000;" class="btn btn-primary">
              <i class="fa fa-trash" aria-hidden="true"></i></a>
              <a href="updateCandidat.php?cin=<?= $candidat['cin'] ?>" style="background-color: #01c7a9;" class="btn btn-primary">
        ...
        ?>
          ...
          <a href="offredemploi.php" style="background-color: #01c7a9;" class="btn btn-primary"> Ajoute Candidat
