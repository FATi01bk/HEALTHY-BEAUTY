            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <div class="d-flex mr-auto flex-column flex-lg-row align-items-center">
                ...
                <li class="nav-item ">
                  ...
                  <li class="nav-item ">
                    <a class="nav-link" href="index.php">Mes donnes personnels</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="contact2.php"> MES RENDEZ VOUS</a>
                  </li>
                                  </ul>
              </div>
              <div class="quote_btn-container">
                ...
                <a href="">
                  <i class="fa fa-user" aria-hidden="true"></i>
                                   <li class="nav-item ">
                    <a class="nav-link" href="contact.php">S'inscrire</a>
                  </li>
        ...
        <div class="col-md-7">
          <div class="form_container">
            <form action="">
              ...
              <div>
                <input type="text" placeholder="donner un ID" />
              </div>

              <div>
                <input type="text" placeholder="Choisir un mot de passe" />
              </div>
