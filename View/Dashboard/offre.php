            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
						...
						<li class="submenu">
							<a href="#"><i class="fa fa-address-book"></i> <span> Offre d'emploi </span> <span class="menu-arrow"></span></a>
							<ul style="display: none;">
								<li><a href="candidats.php">Afficher Candidats</a></li>
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <?php
                    ...
                    $offres = $offreEmploiC->listOffres();
                ?>
                <table>
                    <tr>
                        <th>ID</th>
                    ...
                    <?php foreach ($offres as $offre){ ?>
                      <tr>
                        ...
                        <td><?= $offre['statut'] ?></td>
                        <td><a href="afficherCandidat.php?cin=<?= $offre['cin_c'] ?>"><?= $offre['cin_c'] ?></a></td>
                        <td><a href="deleteOffre.php?id_offre=<?= $offre['id_offre'] ?>" style="background-color: #87C4FF;" class="btn btn-primary">
                          <i class="fa fa-trash" aria-hidden="true"></i></a>
                          <a href="validerOffre.php?id_offre=<?= $offre['id_offre'] ?>&cin_c=<?= $offre['cin_c'] ?>" style="background-color: #01c7a9;" class="btn btn-primary">
                          <i class="fa fa-check" aria-hidden="true"></i></a>
                          <a href="refuserOffre.php?id_offre=<?= $offre['id_offre'] ?>&cin_c=<?= $offre['cin_c'] ?>" style="background-color: #ff0000;" class="btn btn-primary">
