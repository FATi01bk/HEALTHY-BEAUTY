            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-5 col-4">
                        <h4 class="page-title">Candidats</h4>
                    </div>
                </div>
                <div class="d-flex justify-content-center align-items-center">
                    <form method="GET">
                        <div class="form-group row">
                            <div>
                                <input type="search" name="search" class="DocSearch-Input form-control" placeholder="CIN">
                            </div>
                            <div>
...
<?php
    ...
    $candidats = $candidatC->listcandidats();
?>
                <table>
                    <tr>
                        <th>CIN</th>
                    ...
                    <?php foreach ($candidats as $candidat){ ?>
                      <tr>
                        ...
                        <td><a href=<?= $candidat['cv'] ?>> Télécharger le CV </a></td>
                        <td>  <a href="deleteCandidatB.php?cin=<?= $candidat['cin'] ?>" style="background-color: #ff0000;" class="btn btn-primary">
		...
		<div id="delete_candidat" class="modal fade delete-modal" role="dialog">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-body text-center">
						<img src="assets/img/sent.png" alt="" width="50" height="46">
						<h3>Are you sure want to delete this candidat?</h3>
