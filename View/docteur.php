          ...
          <nav class="navbar navbar-expand-lg custom_nav-container ">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <div class="d-flex mr-auto flex-column flex-lg-row align-items-center">
                <ul class="navbar-nav  ">
                  <li class="nav-item ">
                    <a class="nav-link" href="listedespatients.php">Liste des patients </a>
                  </li>

                  <li class="nav-item ">
                    <a class="nav-link" href="index.php">Les rendez-vous</a>
                  </li>
                               </ul>
              </div>
              <div class="quote_btn-container">
                <a href="">
                  ...
                  <li class="nav-item ">
                    <a class="nav-link" href="contact3.php">Se connecter</a>
                  </li>
                </a>
                <a href="">
                  <i class="fa fa-user" aria-hidden="true"></i>
                  <li class="nav-item ">
                    <a class="nav-link" href="contact4.php">S'inscrire</a>
                  </li>
                </a>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="detail-box">
                    ...
                    <h1>
                      HEALTHY BEAUTY <br>
                      <span class="auto-style1">CLINIQUE DERMATOLOGIE</span></h1>
                    <p>
                      Healthy beauty est une clinique de dermathologie qui offre 
					  des séances de dermatologie et des consultations avec 
					  plusieurs médecins .</p>
                    <a href="">
                      Demander un rendez-vous</a></div>
                </div>
                <div class="col-md-6">
                  <div class="img-box">
