...
<center>
    ...
    <h2>
        <a href="addFiche.php">Les  Fiche_Patient</a>
    </h2>
</center>
        ...
        <div class="header">
			<div class="header-left">
				<a href="index-2.html" class="logo">
					<img src="images/logo.png" width="35" height="35" alt=""> <span>Healthy Beauty</span>
				</a>
			</div>
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
						...
						<li class="active">
							<a href="assets.html"><i class="fa fa-cube"></i> <span>Consultation</span></a>
						</li>
						<li>
            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-8 col-6">
                        <h4 class="page-title">Les Fiches_Patients</h4>
                    </div>
                    <div class="col-sm-4 col-6 text-right m-b-30">
                        <a href="add-asset.html" class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Ajouter Fiche</a>
                    </div>
                </div>
                ...
                <table border="1" align="center" width="70%">
                    ...
                    <tr>
                        ...
                        <td><?= $fiche_patient['Prenom']; ?></td><td><?= $fiche_patient['Date_naissance']; ?></td>
                        ...
                        <td align="center">
                            <a href="updateFiche.php?Num_Fich=<?= $fiche_patient['Num_Fich']; ?>">Update</a>
                        </td>
                        <td>
                            <a href="deleteFiche.php?Num_Fich=<?php echo $fiche_patient['Num_Fich']; ?>">Delete</a>
                    </tr>
                    <?php
                    }
                    ?>
